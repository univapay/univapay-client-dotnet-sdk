...
namespace UnivaPay
{
    ...
    public class TransactionTokensApiTest : ApiTestBase
    {
        ...
        public async Task TestTestCreateTransactionToken()
        {
            ...
            // Perform API call
            ApiResponse<TransactionToken> result = null;
            try
            {
        ...
        public async Task TestTestListAllTransactionTokens()
        {
            // Parameters for the API call
            string search = "tokyo";
            Guid? customerId = Guid.Parse("8a3f1b8e-2c1a-4b7a-9c2e-6f6b6f6e2b10");
            Models.TransactionTokenListType type = ApiHelper.JsonDeserialize<Models.TransactionTokenListType>("\"recurring\"");
            Models.ModeQuery mode = ApiHelper.JsonDeserialize<Models.ModeQuery>("\"live\"");
            Models.TransactionTokenActiveFilter active = ApiHelper.JsonDeserialize<Models.TransactionTokenActiveFilter>("\"active\"");
            int? limit = 10;
            ...
            try
            {
                result = await this.controller.ListAllTransactionTokensAsync(search, customerId, type, mode, active, limit, cursor, cursorDirection);
            }
            catch (ApiException)
            {
            }
        ...
        public async Task TestTestListStoreTransactionTokens()
        {
            ...
            try
            {
                result = await this.controller.ListStoreTransactionTokensAsync(storeId, search, customerId, type, mode, active, limit, cursor, cursorDirection);
            }
            catch (ApiException)
            {
            }
        ...
        public async Task TestTestGetTransactionToken()
        {
            ...
            try
            {
                result = await this.controller.GetTransactionTokenAsync(storeId, id, polling);
            }
            catch (ApiException)
            {
            }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestEnableTokenThreeDs()
        {
            // Parameters for the API call
            Guid storeId = Guid.Parse("0cab399b-5621-425b-993b-f8507eba1e78");
            Guid id = Guid.Parse("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
            string idempotencyKey = "f64be872-353d-4c3c-84cb-3dc617fe89f7";
            Models.EnableTokenThreeDsRequest body = ApiHelper.JsonDeserialize<Models.EnableTokenThreeDsRequest>("{\"redirect_endpoint\":\"https://univapay.com/3ds-redirect\"}");

            // Perform API call
            ApiResponse<TransactionToken> result = null;
            try
            {
                result = await this.controller.EnableTokenThreeDsAsync(storeId, id, idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestDisableTokenThreeDs()
        {
            // Parameters for the API call
            Guid storeId = Guid.Parse("0cab399b-5621-425b-993b-f8507eba1e78");
            Guid id = Guid.Parse("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
            ...
            try
            {
                result = await this.controller.DisableTokenThreeDsAsync(storeId, id);
            }
            catch (ApiException)
            {
            }
