// <copyright file="ChargeHandlerAppTests.cs" company="APIMatic">
...
using UnivaPay.FrameworkIntegrations.Webhooks.Apps;
using UnivaPay.Utilities;

namespace UnivaPay.FrameworkIntegrations.Webhooks
{
    public class ChargeHandlerAppTests
    {
        [Test]
        public async Task OnReceiveEvent_Charge_ShouldReturnOk()
        {
            // Arrange
            const string body =
            ...
            var controller = new ChargeApp
            {
                ControllerContext = httpRequestData.CreateControllerContext()
            };
