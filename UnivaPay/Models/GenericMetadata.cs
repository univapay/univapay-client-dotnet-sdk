// <copyright file="GenericMetadata.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class GenericMetadata
    {
        ...
        /// <returns>The GenericMetadataValue value associated with the specified key in the AdditionalProperties dictionary.</returns>
        ...
        public GenericMetadataValue this[string key]
        {
            get => additionalProperties.GetValue<GenericMetadataValue>(key);
            set => additionalProperties.SetValue(key, value, propertyName);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="GenericMetadata"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"GenericMetadata : ({string.Join(", ", toStringOutput)})";
        }
