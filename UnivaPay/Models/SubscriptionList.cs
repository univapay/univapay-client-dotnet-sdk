// <copyright file="SubscriptionList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class SubscriptionList
    {
        ...
        public SubscriptionList(
            List<Models.SubscriptionListItem> items = null,
            bool? hasMore = null,
            int? totalHits = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
        ...
        public List<Models.SubscriptionListItem> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionList : ({string.Join(", ", toStringOutput)})";
        }
