// <copyright file="TokenCreateOnlineData.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class TokenCreateOnlineData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCreateOnlineData"/> class.
        /// </summary>
        ...
        public TokenCreateOnlineData(
            Models.BaseOnlineDataBrand brand,
            Models.BaseOnlineDataCallMethod callMethod,
        ...
        public override string ToString()
        {
            ...
            return $"TokenCreateOnlineData : ({string.Join(", ", toStringOutput)})";
        }
        ...
        {
            toStringOutput.Add($"Brand = {this.Brand}");
            toStringOutput.Add($"CallMethod = {this.CallMethod}");
