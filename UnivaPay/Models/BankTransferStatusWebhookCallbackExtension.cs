// <copyright file="BankTransferStatusWebhookCallbackExtension.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class BankTransferStatusWebhookCallbackExtension
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BankTransferStatusWebhookCallbackExtension"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"BankTransferStatusWebhookCallbackExtension : ({string.Join(", ", toStringOutput)})";
        }
