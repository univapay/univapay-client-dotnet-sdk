// <copyright file="SubscriptionWebhookEvent.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class SubscriptionWebhookEvent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionWebhookEvent"/> class.
        /// </summary>
        ...
        public SubscriptionWebhookEvent(
            Guid id,
            Models.SubscriptionEvent mEvent,
            DateTime createdOn,
        ...
        /// </summary>
        [JsonProperty("event")]
        public Models.SubscriptionEvent MEvent { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionWebhookEvent : ({string.Join(", ", toStringOutput)})";
        }
