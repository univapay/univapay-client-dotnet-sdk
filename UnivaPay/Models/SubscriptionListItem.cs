// <copyright file="SubscriptionListItem.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class SubscriptionListItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionListItem"/> class.
        /// </summary>
        ...
        /// <param name="nextPaymentDate">next_payment_date.</param>
        ...
        public SubscriptionListItem(
            ...
            Models.SubscriptionUserData userData = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
            this.Id = id;
        ...
        public Models.SubscriptionUserData UserData { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionListItem : ({string.Join(", ", toStringOutput)})";
        }
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"NextPaymentDate = {(this.NextPaymentDate == null ? "null" : this.NextPaymentDate.ToString())}");
