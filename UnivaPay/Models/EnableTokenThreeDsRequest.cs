// <copyright file="EnableTokenThreeDsRequest.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class EnableTokenThreeDsRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableTokenThreeDsRequest"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"EnableTokenThreeDsRequest : ({string.Join(", ", toStringOutput)})";
        }
