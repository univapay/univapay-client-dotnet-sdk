// <copyright file="KonbiniTransactionToken.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class KonbiniTransactionToken
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KonbiniTransactionToken"/> class.
        /// </summary>
        ...
        public KonbiniTransactionToken(
            string paymentType,
            Models.TokenResponseKonbiniData data,
            Guid? id = null,
            Guid? storeId = null,
            string email = null,
            bool? active = null,
        ...
        [JsonProperty("data")]
        [JsonRequired]
        public Models.TokenResponseKonbiniData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"KonbiniTransactionToken : ({string.Join(", ", toStringOutput)})";
        }
