// <copyright file="WebhookEventList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class WebhookEventList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventList"/> class.
        /// </summary>
        ...
        public WebhookEventList(
            List<Models.WebhookEvent> items = null,
            bool? hasMore = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
        ...
        public List<Models.WebhookEvent> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"WebhookEventList : ({string.Join(", ", toStringOutput)})";
        }
