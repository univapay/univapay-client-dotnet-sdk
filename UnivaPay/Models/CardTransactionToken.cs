// <copyright file="CardTransactionToken.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class CardTransactionToken
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CardTransactionToken"/> class.
        /// </summary>
        ...
        public CardTransactionToken(
            string paymentType,
            Models.TokenResponseCardData data,
            Guid? id = null,
            Guid? storeId = null,
            string email = null,
            bool? active = null,
        ...
        [JsonProperty("data")]
        [JsonRequired]
        public Models.TokenResponseCardData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"CardTransactionToken : ({string.Join(", ", toStringOutput)})";
        }
