// <copyright file="RefundList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class RefundList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundList"/> class.
        /// </summary>
        public RefundList()
        {
        ...
        public List<Models.Refund> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"RefundList : ({string.Join(", ", toStringOutput)})";
        }
