// <copyright file="MerchantWebhookConvenienceConfiguration.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class MerchantWebhookConvenienceConfiguration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantWebhookConvenienceConfiguration"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"MerchantWebhookConvenienceConfiguration : ({string.Join(", ", toStringOutput)})";
        }
