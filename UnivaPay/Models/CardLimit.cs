// <copyright file="CardLimit.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class CardLimit
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CardLimit"/> class.
        /// </summary>
        public CardLimit()
        {
        ...
        public override string ToString()
        {
            ...
            return $"CardLimit : ({string.Join(", ", toStringOutput)})";
        }
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"Duration = {this.Duration ?? "null"}");
