// <copyright file="PaidyTransactionToken.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class PaidyTransactionToken
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaidyTransactionToken"/> class.
        /// </summary>
        ...
        public PaidyTransactionToken(
            string paymentType,
            Models.TokenResponsePaidyData data,
            Guid? id = null,
            Guid? storeId = null,
            string email = null,
            bool? active = null,
        ...
        [JsonProperty("data")]
        [JsonRequired]
        public Models.TokenResponsePaidyData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"PaidyTransactionToken : ({string.Join(", ", toStringOutput)})";
        }
