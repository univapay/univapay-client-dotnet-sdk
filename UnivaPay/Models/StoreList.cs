// <copyright file="StoreList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class StoreList
    {
        ...
        public StoreList(
            List<Models.StoreListItem> items = null,
            bool? hasMore = null,
            int? totalHits = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
        ...
        public List<Models.StoreListItem> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"StoreList : ({string.Join(", ", toStringOutput)})";
        }
