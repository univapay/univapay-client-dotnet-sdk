// <copyright file="SubscriptionPaymentList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class SubscriptionPaymentList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPaymentList"/> class.
        /// </summary>
        ...
        public SubscriptionPaymentList(
            List<Models.SubscriptionPayment> items = null,
            bool? hasMore = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
        ...
        public List<Models.SubscriptionPayment> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionPaymentList : ({string.Join(", ", toStringOutput)})";
        }
