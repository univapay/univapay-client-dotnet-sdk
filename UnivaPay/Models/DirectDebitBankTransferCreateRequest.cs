// <copyright file="DirectDebitBankTransferCreateRequest.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class DirectDebitBankTransferCreateRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectDebitBankTransferCreateRequest"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"DirectDebitBankTransferCreateRequest : ({string.Join(", ", toStringOutput)})";
        }
