// <copyright file="SubscriptionSuspendRequest.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class SubscriptionSuspendRequest
    {
        ...
        public SubscriptionSuspendRequest(
            Models.SuspendScheduleSettings scheduleSettings = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
        ...
        public Models.SuspendScheduleSettings ScheduleSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionSuspendRequest : ({string.Join(", ", toStringOutput)})";
        }
