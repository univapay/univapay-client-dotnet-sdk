// <copyright file="MerchantWebhookOnlineConfiguration.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class MerchantWebhookOnlineConfiguration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantWebhookOnlineConfiguration"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"MerchantWebhookOnlineConfiguration : ({string.Join(", ", toStringOutput)})";
        }
