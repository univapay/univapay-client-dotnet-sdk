// <copyright file="TransactionTokenList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class TransactionTokenList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionTokenList"/> class.
        /// </summary>
        ...
        public TransactionTokenList(
            List<Models.TransactionTokenListItem> items = null,
            bool? hasMore = null,
            int? totalHits = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
        ...
        public List<Models.TransactionTokenListItem> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"TransactionTokenList : ({string.Join(", ", toStringOutput)})";
        }
