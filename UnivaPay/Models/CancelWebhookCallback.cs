// <copyright file="CancelWebhookCallback.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class CancelWebhookCallback
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelWebhookCallback"/> class.
        /// </summary>
        ...
        public CancelWebhookCallback(
            Guid id,
            DateTime createdOn,
            Models.CancelEvent? mEvent = null,
            Models.Cancel data = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
            this.MEvent = mEvent;
        ...
        public Models.CancelEvent? MEvent { get; set; }
        ...
        public Models.Cancel Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"CancelWebhookCallback : ({string.Join(", ", toStringOutput)})";
        }
