// <copyright file="DirectDebitBankTransferList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class DirectDebitBankTransferList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectDebitBankTransferList"/> class.
        /// </summary>
        ...
        public DirectDebitBankTransferList(
            List<Models.DirectDebitBankTransfer> items = null,
            bool? hasMore = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
        ...
        public List<Models.DirectDebitBankTransfer> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"DirectDebitBankTransferList : ({string.Join(", ", toStringOutput)})";
        }
