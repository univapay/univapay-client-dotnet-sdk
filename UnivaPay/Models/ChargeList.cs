// <copyright file="ChargeList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class ChargeList
    {
        ...
        public List<Models.Charge> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"ChargeList : ({string.Join(", ", toStringOutput)})";
        }
