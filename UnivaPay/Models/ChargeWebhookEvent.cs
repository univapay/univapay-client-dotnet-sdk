// <copyright file="ChargeWebhookEvent.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class ChargeWebhookEvent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeWebhookEvent"/> class.
        /// </summary>
        ...
        public ChargeWebhookEvent(
            Guid id,
            Models.ChargeEvent mEvent,
            DateTime createdOn,
            Models.Charge data = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
            this.Id = id;
        ...
        /// </summary>
        [JsonProperty("event")]
        public Models.ChargeEvent MEvent { get; set; }

        /// <summary>
        /// Charge resource returned by the payments API.
        /// </summary>
        [JsonProperty("data", NullValueHandling = NullValueHandling.Ignore)]
        public Models.Charge Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"ChargeWebhookEvent : ({string.Join(", ", toStringOutput)})";
        }
