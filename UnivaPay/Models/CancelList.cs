// <copyright file="CancelList.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class CancelList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelList"/> class.
        /// </summary>
        public CancelList()
        {
        ...
        public List<Models.Cancel> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"CancelList : ({string.Join(", ", toStringOutput)})";
        }
