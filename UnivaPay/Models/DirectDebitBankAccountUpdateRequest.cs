// <copyright file="DirectDebitBankAccountUpdateRequest.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class DirectDebitBankAccountUpdateRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectDebitBankAccountUpdateRequest"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"DirectDebitBankAccountUpdateRequest : ({string.Join(", ", toStringOutput)})";
        }
