// <copyright file="RefundWebhookCallback.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class RefundWebhookCallback
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundWebhookCallback"/> class.
        /// </summary>
        ...
        public RefundWebhookCallback(
            Guid id,
            DateTime createdOn,
            Models.RefundEvent? mEvent = null,
            Models.Refund data = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
            this.MEvent = mEvent;
        ...
        public Models.RefundEvent? MEvent { get; set; }
        ...
        public Models.Refund Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"RefundWebhookCallback : ({string.Join(", ", toStringOutput)})";
        }
