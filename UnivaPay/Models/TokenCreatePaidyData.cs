// <copyright file="TokenCreatePaidyData.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class TokenCreatePaidyData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCreatePaidyData"/> class.
        /// </summary>
        ...
        public TokenCreatePaidyData(
            string paidyToken,
            Models.TokenCreatePaidyDataShippingAddress shippingAddress,
        ...
        [JsonRequired]
        public Models.TokenCreatePaidyDataShippingAddress ShippingAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"TokenCreatePaidyData : ({string.Join(", ", toStringOutput)})";
        }
