// <copyright file="TokenResponseOnlineData.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class TokenResponseOnlineData
    {
        ...
        private string issuerTokenPayload;
        private Dictionary<string, bool> shouldSerialize = new Dictionary<string, bool>
        {
            ...
            { "issuer_token", false },
            { "issuer_token_payload", false },
        };

        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResponseOnlineData"/> class.
        /// </summary>
        ...
        /// <param name="issuerTokenPayload">issuer_token_payload.</param>
        public TokenResponseOnlineData(
            ...
            string issuerToken = null,
            string issuerTokenPayload = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
            this.Brand = brand;
        ...
        public string IssuerTokenPayload
        {
            ...
            set
            {
                this.shouldSerialize["issuer_token_payload"] = true;
                this.issuerTokenPayload = value;
            }
        }
        ...
        public override string ToString()
        {
            ...
            return $"TokenResponseOnlineData : ({string.Join(", ", toStringOutput)})";
        }
        ...
        {
            this.shouldSerialize["issuer_token_payload"] = false;
        }
        ...
        /// </summary>
        /// <returns>A boolean weather the field should be serialized or not.</returns>
        public bool ShouldSerializeIssuerTokenPayload()
        {
            return this.shouldSerialize["issuer_token_payload"];
        }
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"IssuerTokenPayload = {this.IssuerTokenPayload ?? "null"}");
