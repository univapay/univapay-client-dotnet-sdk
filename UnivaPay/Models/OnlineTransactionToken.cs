// <copyright file="OnlineTransactionToken.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class OnlineTransactionToken
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OnlineTransactionToken"/> class.
        /// </summary>
        ...
        public OnlineTransactionToken(
            string paymentType,
            Models.TokenResponseOnlineData data,
            Guid? id = null,
            Guid? storeId = null,
            string email = null,
            bool? active = null,
        ...
        [JsonProperty("data")]
        [JsonRequired]
        public Models.TokenResponseOnlineData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"OnlineTransactionToken : ({string.Join(", ", toStringOutput)})";
        }
