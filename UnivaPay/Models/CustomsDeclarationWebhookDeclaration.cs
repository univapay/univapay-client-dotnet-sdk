// <copyright file="CustomsDeclarationWebhookDeclaration.cs" company="APIMatic">
// UnivaPay
//
...
namespace UnivaPay.Models
{
    ...
    public class CustomsDeclarationWebhookDeclaration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomsDeclarationWebhookDeclaration"/> class.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("merchant_customs_no", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            return $"CustomsDeclarationWebhookDeclaration : ({string.Join(", ", toStringOutput)})";
        }
