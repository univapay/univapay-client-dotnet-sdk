...
| `PaymentType` | `string` | Required, Constant | Payment method type. Always `qr_scan` for this variant.<br><br>**Value**: `"qr_scan"` |
...
QrScanTransactionToken qrScanTransactionToken = new QrScanTransactionToken
{
    PaymentType = "qr_scan",
