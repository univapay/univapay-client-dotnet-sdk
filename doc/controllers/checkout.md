...
```csharp
CheckoutApi checkoutApi = client.CheckoutApi;
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.CheckoutInfo](../../doc/models/checkout-info.md).
...
try
{
    ApiResponse<CheckoutInfo> result = await checkoutApi.GetCheckoutInfoAsync();
}
