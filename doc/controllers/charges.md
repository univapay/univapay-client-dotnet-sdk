...
```csharp
ChargesApi chargesApi = client.ChargesApi;
```
...
```csharp
ChargeCreateRequest body = new ChargeCreateRequest
{
    ...
    Redirect = new ChargeCreateRequestRedirect
    {
...
try
{
    ApiResponse<Charge> result = await chargesApi.CreateChargeAsync(
        null,
        body
    );
}
...
| `transactionTokenId` | `Guid?` | Query, Optional | Filter by transaction token ID. |
...
Guid? transactionTokenId = new Guid("f33b673e-564c-4645-ae17-ca03846a86b7");
try
{
    ApiResponse<ChargeList> result = await chargesApi.ListAllChargesAsync(
        limit,
        cursor,
        cursorDirection,
        lastFour,
...
try
{
    ApiResponse<ChargeList> result = await chargesApi.ListStoreChargesAsync(
        storeId,
        limit,
        cursor,
        cursorDirection,
...
try
{
    ApiResponse<Charge> result = await chargesApi.GetChargeAsync(
        storeId,
        id,
        polling
    );
...
Guid storeId = new Guid("0cab399b-5621-425b-993b-f8507eba1e78");
Guid id = new Guid("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
ChargeUpdateRequest body = new ChargeUpdateRequest
{
    Metadata = new GenericMetadata
    {
        OrderId = "1234",
...
try
{
    ApiResponse<Charge> result = await chargesApi.UpdateChargeAsync(
        storeId,
        id,
        null,
        body
...
Guid storeId = new Guid("0cab399b-5621-425b-993b-f8507eba1e78");
Guid id = new Guid("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
ChargeCaptureRequest body = new ChargeCaptureRequest
{
    Amount = 1000,
    Currency = "JPY",
};
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.IssuerToken](../../doc/models/issuer-token.md).
...
try
{
    ApiResponse<IssuerToken> result = await chargesApi.GetChargeIssuerTokenAsync(
        storeId,
        id
    );
}
...
```csharp
GetChargeThreeDsIssuerTokenAsync(
    Guid storeId,
    Guid id)
```
...
try
{
    ApiResponse<ThreeDsIssuerToken> result = await chargesApi.GetChargeThreeDsIssuerTokenAsync(
        storeId,
        id
    );
}
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.BankTransferLedgerList](../../doc/models/bank-transfer-ledger-list.md).
...
try
{
    ApiResponse<BankTransferLedgerList> result = await chargesApi.ListBankTransferLedgersAsync(
        storeId,
        id
    );
}
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.CustomsDeclarationWebhookData](../../doc/models/customs-declaration-webhook-data.md).
...
CustomsDeclarationCreateRequest body = new CustomsDeclarationCreateRequest
{
    Customs = "TOKYO",
...
try
{
    ApiResponse<CustomsDeclarationWebhookData> result = await chargesApi.CreateCustomsDeclarationAsync(
        storeId,
        chargeId,
        body,
        idempotencyKey
...
| `storeId` | `Guid` | Template, Required | The unique identifier of the store. |
| `chargeId` | `Guid` | Template, Required | The unique identifier of the charge. |
| `id` | `Guid` | Template, Required | The unique identifier of the customs declaration. |
...
Guid storeId = new Guid("0cab399b-5621-425b-993b-f8507eba1e78");
Guid chargeId = new Guid("6efb4e5c-690a-40f3-a4f1-0e19c5f84e98");
Guid id = new Guid("11ef0000-0000-4000-8000-000000000040");
bool? polling = false;
try
{
    ApiResponse<CustomsDeclarationWebhookData> result = await chargesApi.GetCustomsDeclarationAsync(
        storeId,
        chargeId,
        id,
        polling
...
Guid chargeId = new Guid("6efb4e5c-690a-40f3-a4f1-0e19c5f84e98");
Guid id = new Guid("11ef0000-0000-4000-8000-000000000040");
CustomsDeclarationPatchRequest body = new CustomsDeclarationPatchRequest
{
...
try
{
    ApiResponse<CustomsDeclarationWebhookData> result = await chargesApi.PatchCustomsDeclarationAsync(
        storeId,
        chargeId,
        id,
        body,
