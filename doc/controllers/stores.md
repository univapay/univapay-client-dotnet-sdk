...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.CreateCustomerIdResponse](../../doc/models/create-customer-id-response.md).

## Example Usage

```csharp
Guid storeId = new Guid("0cab399b-5621-425b-993b-f8507eba1e78");
CreateCustomerIdRequest body = new CreateCustomerIdRequest
{
...
try
{
    ApiResponse<CreateCustomerIdResponse> result = await storesApi.CreateCustomerIdAsync(
        storeId,
        body
    );
}
